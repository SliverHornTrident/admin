...
func newDictionary(db *gorm.DB, opts ...gen.DOOption) dictionary {
	...
	_dictionary.IsDelete = field.NewUint(tableName, "is_delete")
	_dictionary.Key = field.NewString(tableName, "key")
	_dictionary.Type = field.NewString(tableName, "type")
	_dictionary.Value = field.NewString(tableName, "value")
	_dictionary.Sort = field.NewInt(tableName, "sort")
	_dictionary.Status = field.NewBool(tableName, "status")
	_dictionary.Description = field.NewString(tableName, "desc")
...
func (d *dictionary) updateTableName(table string) *dictionary {
	...
	d.Description = field.NewString(table, "desc")
...
func (a dictionaryHasManyDetails) Session(session *gorm.Session) *dictionaryHasManyDetails {
